...
public class Homework2 {
    ...
    public static void ex1() {
        ...
        // С помощью циклов и функции String.substring составитьитоговый текст
    ...
    public static void ex3() {
        ...
        for (int i = 1; true; i++) {
            if(number == 999){
                System.out.printf("Номер попытки, с которой получилось получить случайным образом число 999 - %d\n", i);
                break;
            }
